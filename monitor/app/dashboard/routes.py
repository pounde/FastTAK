...
async def logs_page(request: Request):
    ...
    return templates.TemplateResponse(request, "logs.html",
                                      _page_context(containers=discover_services()))
...
def ui_health_grid(request: Request):
    ...
    return templates.TemplateResponse(request, "partials/health_grid.html",
                                      {"containers": data})
...
def ui_cert_status(request: Request):
    ...
    return templates.TemplateResponse(request, "partials/cert_status.html",
                                      {"certs": data})
...
async def ui_update_status(request: Request):
    ...
    return templates.TemplateResponse(request, "partials/update_status.html",
                                      {"updates": data})
...
async def ui_activity_log(request: Request):
    ...
    return templates.TemplateResponse(request, "partials/activity_log.html",
                                      {"events": data})
...
def ui_disk_usage(request: Request):
    ...
    data = get_disk_usage()
    return templates.TemplateResponse(request, "partials/disk_usage.html",
                                      {"disks": data})
...
def ui_tls_status(request: Request):
    ...
    data = get_tls_status()
    return templates.TemplateResponse(request, "partials/tls_status.html",
                                      {"tls_certs": data})
...
def ui_config_status(request: Request):
    ...
    return templates.TemplateResponse(request, "partials/config_status.html",
                                      {"config": data})
